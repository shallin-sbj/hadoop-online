package com.scl.online.hbase.repository;
...
public class HBaseService {
    ...
    /**
     * 根据startRowKey和prefix遍历查询指定表中的所有数据
     *
     * @param tableName   表名
     * @param prefix      行prefix
     * @param startRowKey 起始rowKey
     */
    public Map<String, Map<String, String>> getResultScannerPrefixFilter(String tableName, String prefix, String startRowKey) {
        Scan scan = new Scan();
    ...
    /**
     * 根据startRowKey和prefix遍历查询指定表中的数据
     *
     * @param tableName   表名
     * @param prefix      行prefix
     * @param startRowKey 起始rowKey
     ...
     */
    public TreeMap<String, Map<String, String>> getResultScannerPrefixFilter(String tableName, String prefix, String startRowKey, int pageSize) {
        Scan scan = new Scan();
        ...
        if (pageSize != 0) {
            ...
            pageFilter = new PageFilter(1000);
        }
        filterList.addFilter(pageFilter);
        scan.setFilter(filterList);
        return this.queryData2(tableName, scan);
    }
     ...
     * @param scan      过滤条件
     */
    private TreeMap<String, Map<String, String>> queryData2(String tableName, Scan scan) {
        //<rowKey,对应的行数据>
