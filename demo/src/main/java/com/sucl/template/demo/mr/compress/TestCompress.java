package com.sucl.template.demo.mr.compress;
...
public class TestCompress {
    ...
    public static void zip(Class codecClass) throws Exception {
        ...
        //创建文件输出流,得到默认扩展名
        FileOutputStream fos = new FileOutputStream("D:/data/com/b." + codec.getDefaultExtension());
        //得到压缩流
        CompressionOutputStream zipOut = codec.createOutputStream(fos);
        IOUtils.copyBytes(new FileInputStream("D:/data/com/a.txt"), zipOut, 1024);
        zipOut.close();
